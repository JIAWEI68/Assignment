...
class RestaurantDB{
    ...
    var sql = "SELECT a.id, a.name, a.location, a.map, a.telephone_number, a.opening_hours, a.description, a.rating, a.cuisine, a.compass_location, a.title_picture, a.description_picture FROM reviews.restaurant a WHERE a.cuisine IN ('Western')"
    db.query(sql,callback)
    }
    ...
    var sql = "SELECT b.id,b.name,b.location,b.map,b.telephone_number,b.opening_hours,b.description,b.rating,b.cuisine,b.compass_location,b.title_picture,b.description_picture FROM reviews.restaurant  WHERE cuisine = 'Malay'"
    db.query(sql,callback)
    }
    getNorthRestaurant(callback){
    var sql = "SELECT c.id,c.name,c.location,c.map,c.telephone_number,c.opening_hours,c.description,c.rating,c.cuisine,c.compass_location,c.title_picture,c.description_picture FROM reviews.restaurant WHERE compass_location = 'North'"
    db.query(sql,callback);
    }
